...
The next method we will cover is slice(). slice(), rather than modifying an array, copies, or extracts, 
...
but not including the element at this index). Consider this:
